...
function CreateTaskView({
  ...
  // Telegram completion-notification preferences. The controls for these were
  // removed from the UI, but the values are still submitted and the backend
  // notifier still reads them — so editing a task preserves whatever it had, and
  // new tasks take the previous defaults.
