...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.openInNewPane": "Open in new pane",
    "sidebar.markUnread": "Mark as unread",
    "sidebar.markRead": "Mark as read",
    "route.button": "Route",
    "route.title": "Provider routing",
    "route.loading": "Loading providers…",
    "route.none": "Only one provider serves this model",
    "route.error": "Could not load providers",
    "route.saveFailed": "Could not save routing",
    "route.replyLength": "reply length",
    "route.sortLabel": "When several are allowed, prefer",
    "route.sortDefault": "OpenRouter default",
    "route.sortThroughput": "Fastest overall",
    "route.sortLatency": "Fastest to start",
    "route.pinnedCount": "{count} pinned",
    "route.unmeasured": "no data",
    "route.colProvider": "Provider",
    "route.colTime": "time",
    "route.colTps": "tok/s",
    "route.colStart": "start",
    "route.colAvgPrice": "avg $/M",
    "route.colCachePrice": "cache $/M",
    "route.avgPriceHint": "Mean of the input and output rate per million tokens. Unweighted, so it gives output more weight than a coding turn does.",
    "route.cachePriceHint": "Rate for context read back from the provider's cache. Dimmed where it is published but never charged for this model's requests.",
    "route.cacheApplied": "Repeated context bills at this rate.",
    "route.cacheNotApplied": "Published rate, not charged for this model's requests.",
    "route.cheapest": "cheapest",
    "route.dearest": "most expensive",
    "pane.running": "Working",
    "pane.unread": "Finished while you were elsewhere",
    "pane.untitled": "New session",
    "codex.quota": "Codex Quota",
    "codex.plan": "Plan",
    "codex.window": "Window",
    "codex.used": "Used",
    "codex.resets": "Resets",
    "codex.resetCredits": "Reset credits",
    "codex.updated": "Updated {age}",
    ...
    "chat.processModels": "{count} models",
    "chat.contextLines": "{count} lines",
    "chat.stopping": "Stopping…",
    "chat.forceReset": "Force reset",
    "chat.forceResetHint": "Drop this session's agent process. Use when Stop does not respond — the conversation is kept.",
    "chat.removeContext": "Remove this context",
    "selection.toolbar": "Selection actions",
    "selection.addToChat": "Add to chat",
    "selection.explain": "Explain",
    "selection.improve": "Improve",
    "selection.shorten": "Shorten",
    ...
    "changes.expandAll": "Expand all diffs",
    "changes.collapseAll": "Collapse all diffs",
    "changes.changedOnly": "Show changed lines only",
    "changes.showContext": "Show surrounding code",
    "changes.hiddenLines": "{count} unchanged lines hidden",
    ...
    "i18n.thoughtFor": "Thought for {duration}",
    ...
    "task.type.hourly": "Every N hours",
    "task.type.once": "Once",
    ...
    "task.create.intervalHours": "Interval (hours)",
    "task.create.minute": "At minute",
    ...
    "subagents.activity": "Activity",
    "subagents.result": "Result",
    "subagents.showResult": "Show result",
    "subagents.hideResult": "Hide result",
    "subagents.waitingActivity": "Waiting for activity…",
    "subagents.noActivity": "No activity captured.",
    ...
    "deepseek.pricingUpcoming": "From 16 Aug, DeepSeek’s API charges 2x during {windows}.",
    "deepseek.pricingPeak": "DeepSeek API peak pricing until {until} — 2x off-peak rates.",
    "deepseek.pricingOffPeak": "DeepSeek API off-peak until {until}. Peak hours ({windows}) cost 2x.",
    "search.title": "Find a session",
    "search.description": "Search every conversation by name or content.",
    "search.placeholder": "What was that session about?",
    "search.ask": "Ask the model",
    "search.asking": "Reading sessions...",
    "search.searching": "Searching...",
    "search.resultCount": "{count} sessions",
    "search.noResults": "No sessions match yet.",
    "search.nameMatch": "name",
    "search.contextMatch": "content",
    "search.picked": "best match",
    "search.copyLink": "Copy link",
    "search.copied": "Copied",
    "search.copyFailed": "Could not copy the link.",
    "search.openHint": "Open this session",    "search.typeToStart": "Type at least two characters to search your sessions.",
    "search.open": "Search sessions",
    "search.pickerOffTitle": "Model ranking is off",
    "search.pickerNoCredentials": "Add an OpenRouter API key in Models to let a model read the candidates and pick the right session. Name search still works without it.",
    "search.pickerNoModel": "The ranking model {model} is not in your model list. Add it under Models, or search by name and content below.",
    "search.pickerRuntimeError": "Could not read your model configuration, so model ranking is unavailable. Name and content search still work.",
    "search.pickerOpenModels": "Open Models",
    "search.askDisabledHint": "Requires an OpenRouter key",
  },
};
